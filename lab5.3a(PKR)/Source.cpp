...
void Add(char* fname)
{
	...
	do
	{
		...
		cin.get();
		cin.sync();
		cout << " Прізвище: "; cin.getline(s.lname, 30);
		cout << " Курс: "; cin >> s.kurs;
		cout << " Спецiальнiсть (0 - Фiзика та iнформатика, 1 - Математика та економiка, 2 - Iнформатика) "; cin >> speciality;
		s.spec = (Spec)speciality;
		cout << " Оцiнка з фiзики: "; cin >> s.physics;
		cout << " Оцiнка з математики: "; cin >> s.math;
		cout << " Оцінка з інформатики: "; cin >> s.comscience;
		cout << endl;
		i++;
